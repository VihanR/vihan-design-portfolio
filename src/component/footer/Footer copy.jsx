...
const logoUrl = <img style = {{width:'80px'}} src="/assets/images/logo/logo-1.png" alt="Vihan Ramanayake" />;
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-4 col-xl-4 offset-xl-2 col-md-12 col-sm-12 col-12">
                                    <div className="call-to-cation-tbn text-left text-lg-right mt_md--20 mt_sm--20">
                                        <a className="btn-default btn-large btn-border btn-opacity" href="#button">Reach Out Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
