...
class ProjectDreamtime extends Component{
    ...
    render(){
        ...
        return(
            <React.Fragment>
                <PageHelmet pageTitle='Project Dreamtime' />
                                            ...
                                            <div className="row row--35 sercice-details-content align-items-center">
                                                <div className="col-lg-6 col-12">
                                                    <div className="thumb position-relative text-right">
                                                      <img style = {{marginRight:'40px'}} src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/artwork-upload.gif")} alt = "Walkthrough"></img>
                                                    </div>
                                                </div>
                                                <div className="col-lg-6 col-12">
                                            ...
                                            <div className="row row--35 sercice-details-content align-items-center">
                                                ...
                                                <div className="col-lg-6 col-12 mt_md--30 mt_sm--30">
                                                    <div className="thumb position-relative">
                                                        <img style = {{marginLeft:'40px'}}src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/explore-artwork.gif")} alt = "Walkthrough"></img>
                                                    </div>
                                                </div>
                                            </div>
                                            {/* End Single Area */}
                                ...
                                <div className="col-lg-12 text-center">
                                    <div className="related-work mt--30">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/design-process.svg")} alt = "Design Process"/>                                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div className="row mt--10">
                                            <div className="col-lg-4 col-md-6 col-12">
                                                <div className="related-work mt--30">
                                                    ...
                                                    src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/artist-1.svg")} alt="Artist Survey" />                                                    
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-10">
                                                <div className="related-work mt--30">
                                                    ...
                                                    src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/artist-2.svg")} alt="Artist Survey" />                                                    
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-12">
                                                <div className="related-work mt--30">
                                                    <LazyLoadImage 
                                                        ...
                                                        src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/artist-3.svg")} alt="Artist Survey" />                                                    
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row mt--10">
                                            <div className="col-lg-4 col-md-6 col-12">
                                                <div className="related-work mt--30">
                                                    ...
                                                    src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/general-1.svg")} alt="Art Enthusiast Survey" />                                                    
                                                </div>
                                            </div>
                                            <div className="col-lg-4 col-md-6 col-10">
                                                <div className="related-work mt--30">
                                                    ...
                                                    src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/general-2.svg")} alt="Art Enthusiast Survey" />                                                    
                                                </div>
                                            </div>  
                                            <div className="col-lg-4 col-md-6 col-10">
                                                <div className="related-work mt--30">
                                                    ...
                                                    src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/general-3.svg")} alt="Art Enthusiast Survey" />                                                    
                                                </div>
                                            </div>                                                                  
                                        </div>
                                    </div>                          
                                ...
                                <div className="col-lg-12">
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/artist-user-flow.svg")} alt="Artist User Flow" />                                                    
                                    </div>
                                </div>
                                <div className="col-lg-12">
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/general-user-flow.svg")} alt="General User Flow" />                                                    
                                    </div>
                                </div>    
                            </div>  
                        </div> 
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/whiteboard.svg")} alt="Whiteboard Sketch" />                                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/low-fid-1.svg")} alt="Low Fidelity Wireframes" />                                                    
                                    </div>
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            style = {{
                                            ...
                                            src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/low-fid-2.svg")} alt="Low Fidelity Wireframes" />                                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="row">
                                ...
                                <div className= "col-lg-6 col-md-6 col-12">
                                    <div className="related-work mt--30">
                                        ...
                                        src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/big/testing-3.png")} alt = "Usability Workshop" />                                                    
                                    </div>
                                </div>
                                <div className="col-lg-6 col-md-6 col-12">
                                    <div className="related-work mt--30">
                                        ...
                                        src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/big/testing-4.png")} alt = "Usability Workshop" />                                                    
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/feature-prio.svg")} alt="Feature Prioritisation Matrix" />                                                    
                                    </div>
                                </div>
                            </div>
                        </div>  
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="related-work mt--30 text-center">
                                        <LazyLoadImage 
                                            ...
                                            src= {require ("C:/Portfolio/imroz/public/assets/images/portfolio/style-guide.svg")} alt="Application Style Guide" />                                                    
                                    </div>
                                </div>
                            </div> 
                        </div> 
                        ...
                        <div style = {{paddingBottom:'50px'}} className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    ...
                                    <div className= "style-guide-desc"></div>
                                    <p style = {{paddingTop: '20px'}}>Below are the final high-fidelity wireframes that were created in Figma, visually outlining each step of the user’s journey. </p>
                                    <div style = {{paddingTop:'40px'}}className="app-wireframe-carousel">
                                        
                                        <AliceCarousel>
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-1.svg")} alt ="Prototype: High-Fid"/>                                     
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-2.svg")} alt ="Prototype: High-Fid"/>                                     
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-3.svg")} alt ="Prototype: High-Fid"/>                                     
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-4.svg")} alt ="Prototype: High-Fid"/>                                     
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-5.svg")} alt ="Prototype: High-Fid"/>  
                                            <LazyLoadImage src = {require ("C:/Portfolio/imroz/public/assets/images/portfolio/high-fid-6.svg")} alt ="Prototype: High-Fid"/>                                                                         
                                        </AliceCarousel>
...
export default ProjectDreamtime;
